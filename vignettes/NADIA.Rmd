...
img[src$="Three_Proteome_Experimental_Design.svg"].three-proteome-clickable {
  cursor: zoom-in;
}
.volcano-ba-figure img.volcano-ba-clickable {
  cursor: zoom-in;
}
.figure-zoom-hint {
...
#volcano-ba-lightbox.is-open {
  display: flex;
}
#three-proteome-lightbox img,
#volcano-ba-lightbox img {
...
<script>
(function () {
  var source = document.querySelector(".volcano-ba-figure img");
  if (!source) return;

  source.classList.add("volcano-ba-clickable");
  source.setAttribute("tabindex", "0");
  source.setAttribute("title", "Click to enlarge the B-A volcano plot");

  var lightbox = document.createElement("div");
  lightbox.id = "volcano-ba-lightbox";
  lightbox.setAttribute("role", "dialog");
  lightbox.setAttribute("aria-modal", "true");
  lightbox.setAttribute("aria-label", "Enlarged B-A volcano plot");
  lightbox.setAttribute("aria-hidden", "true");

  var enlarged = source.cloneNode(true);
  enlarged.classList.remove("volcano-ba-clickable");
  enlarged.removeAttribute("tabindex");
  enlarged.removeAttribute("title");
  enlarged.removeAttribute("width");
  ...
  function openLightbox() {
    lightbox.classList.add("is-open");
    lightbox.setAttribute("aria-hidden", "false");
    document.body.classList.add("volcano-ba-lightbox-open");
    closeButton.focus();
  }
  ...
  function closeLightbox() {
    lightbox.classList.remove("is-open");
    lightbox.setAttribute("aria-hidden", "true");
    document.body.classList.remove("volcano-ba-lightbox-open");
    source.focus();
  }
