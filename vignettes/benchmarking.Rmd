...
to condition D. Four pseudo-biological replicates were measured per condition.
...
head(wrong_sign[, c("Protein.IDs", "Comparison", "Species", "logFC",
                    ...
                    "direction_error", "classification")], 4)
```
...
attributable to the search-engine pipelines.
